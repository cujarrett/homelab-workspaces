...
XR instance files for all workspace apps running on the [homelab](https://github.com/cujarrett/homelab) cluster. Most files here are written automatically by `launchpad-api` via the GitHub Contents/Git Data API, not hand-edited.
